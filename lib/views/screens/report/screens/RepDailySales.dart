...
import '../controller/repDailySalesController.dart';



class RepDailySalesScreen extends StatefulWidget {
  const RepDailySalesScreen({Key? key}) : super(key: key);

  @override
  State<RepDailySalesScreen> createState() => _RepDailySalesScreenState();
}

class _RepDailySalesScreenState extends State<RepDailySalesScreen> {
  final RepDailySalesController repDailySalesController=Get.put(RepDailySalesController());
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        leading: IconButton(
          onPressed: () {
            repDailySalesController.fnBackPage(context);
          },
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  Row(
                    ...
                    children: [
                      ...
                      Bounce(
                        duration: const Duration(milliseconds: 110),
                        onPressed: (){
                          repDailySalesController.isExpanded.value=!repDailySalesController.isExpanded.value;
                          dprint(repDailySalesController.isExpanded.value);
                        },
                        child: Container(
                          decoration: boxDecoration(white, 10),
                          padding: const EdgeInsets.symmetric(horizontal: 5,vertical: 5),
                          child:  Icon(repDailySalesController.isExpanded.value==true?Icons.arrow_drop_down_sharp:Icons.arrow_drop_up,size: 18,),
                        ),
                      ),
                    ],
                  ),
                  ...
                  repDailySalesController.isExpanded.value==true?  Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      const Divider(),
                      Container(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Bounce(
                                        duration: const Duration(milliseconds: 110),
                                        onPressed: (){
                                          repDailySalesController.wSelectFromDate(context);
                                        },
                                        child: Container(
                                            ...
                                            children: [
                                              Row(
                                                children: [
                                                  ...
                                                  gapWC(5),
                                                  tcn(setDate(15,repDailySalesController.fromDate.value).toString(), Colors.black, 13)
                                                ],
                                              ),
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Bounce(
                                        duration: const Duration(milliseconds: 110),
                                        onPressed: (){
                                          repDailySalesController.wSelectToDate(context);
                                        },
                                        child: Container(
                                          padding: const EdgeInsets.symmetric(horizontal: 10,vertical: 6),
                                          decoration: BoxDecoration(
                                            ...
                                            children: [
                                              Row(
                                                children: [
                                                  ...
                                                  gapWC(5),
                                                  tcn(setDate(15,repDailySalesController.toDate.value).toString(), Colors.black, 13)
                                                ],
                                              ),
