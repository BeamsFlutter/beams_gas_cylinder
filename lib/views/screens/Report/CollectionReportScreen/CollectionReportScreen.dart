...
import 'CollectionreportController/CollectionReportController.dart';

class CollectionReportScreen extends StatefulWidget {
   CollectionReportScreen({Key? key}) : super(key: key);
...
class _CollectionReportScreenState extends State<CollectionReportScreen> {
  final CollectionReportController collectionReportController= Get.put(CollectionReportController());
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: tcn('Collection Report', black, 20),
        actions: const [
          Padding(
                      ...
                      Flexible(child:  Column(crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          ...
                          Bounce(
                            ...
                            onPressed: () {
                              collectionReportController.wSelectDate(context);
                              gapHC(5);
                            },
                            child:  CommonTextField(
                              obscureY: false,
                              textStyle: const TextStyle(color: txtColor),
                              txtController: collectionReportController.txtFromdate,
                      ...
                      Flexible(child: Column(crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          ...
                          Bounce(
                            duration: const Duration(milliseconds: 110),
                            onPressed: () {
                              collectionReportController.wSelectDateto(context);
                              gapHC(5);
                            },
                            child:  CommonTextField(
                              obscureY: false,
                              textStyle: const TextStyle(color: txtColor),
                              txtController: collectionReportController.txtTodate,
                              prefixIcon: Icons.calendar_month,
                              prefixIconColor: black,
                              suffixIcon: Icons.search,
                              enableY: false,
