...
import '../controller/hmPreviousDeliveryOrderController.dart';
import '../controller/hmPreviousSaleController.dart';

class PreviousDeliveryOrder extends StatefulWidget {
  const PreviousDeliveryOrder({super.key});

  @override
  State<PreviousDeliveryOrder> createState() => _PreviousDeliveryOrderState();
}

class _PreviousDeliveryOrderState extends State<PreviousDeliveryOrder> {
  final HmPreviousDeliveryOrderController hmPreviousDelivryOrderController = Get.put(HmPreviousDeliveryOrderController());
        ...
        body: Padding(
            ...
            child: Column(
              children: [
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Bounce(
                          ...
                          onPressed: () {
                            hmPreviousDelivryOrderController.fnLookup("GCYLINDER_DO");
                          },
                          child: Container(
                              ...
                              children: [
                                Row(
                                  children: [
                                    ...
                                    tc(hmPreviousDelivryOrderController.frDocType.value, txtColor, 12)
                                  ],
                                ),
                                gapWC(5),
                              ...
                              children: [
                                Row(
                                  children: [
                                    ...
                                    tc(hmPreviousDelivryOrderController.frDocno.value, txtColor, 12)
                                  ],
                                ),
                                gapWC(5),
                                const Icon(Icons.search,size: 14,)
                        ...
                        child: Container(
                          ...
                          child: Checkbox(
                            ...
                            // ),
                              ...
                              value: hmPreviousDelivryOrderController.checkAll.value,
                              onChanged: (value){
                                hmPreviousDelivryOrderController.checkAll.value=value!;
                                hmPreviousDelivryOrderController.fncheckAllItem();
                ...
                GetBuilder<HmPreviousDeliveryOrderController>(builder: (controller){
                  return  Column(
              ...
              Row(
                children: [
                  Checkbox(
                      ...
                      onChanged: (value){
                        if(e["isCheck"]==false){
                          hmPreviousDelivryOrderController.checkAll.value=false;
                        }
