...
class HmeSalesOrder extends StatefulWidget {
  final String ? bookingNumber;
  const HmeSalesOrder({super.key,this.bookingNumber});

  @override
  State<HmeSalesOrder> createState() => _HmeSalesOrderState();
}

class _HmeSalesOrderState extends State<HmeSalesOrder> {
  final HmSalesOrderController hmSalesOrderController =   Get.put(HmSalesOrderController());
  @override
  void initState() {
    hmSalesOrderController.pageController = PageController();
    var bookingNumber = widget.bookingNumber??"";

    if(bookingNumber.isNotEmpty){
      hmSalesOrderController.wstrPageMode.value = "ADD";
      dprint("Call Booking Detail Api");
      hmSalesOrderController.apiGetBooking(bookingNumber, "mode");
    }else{
      hmSalesOrderController.wstrPageMode.value = 'VIEW';
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() => Scaffold(
        appBar: AppBar(
          ...
          leading: IconButton(
            onPressed: () {
              hmSalesOrderController.fnBackPage(context);
            },
                    ...
                    children: [
                            ...
                            children: [
                              Row(
                                children: [
                                  ...
                                  tc(hmSalesOrderController.frDocno.value, txtColor, 12)
                                ],
                              ),
                              gapWC(5),
                      ...
                      Row(
                        children: [
                          ...
                          gapWC(3),
                          tcn(
                              setDate(7, hmSalesOrderController.docDate.value)
                                  .toString()
                                  .toUpperCase(),
                              txtColor,
                              12)
                      ...
                      children: [
                        Flexible(
                          child: TabButton(
                              ...
                              pageNumber: 0,
                              selectedPage:
                              hmSalesOrderController.selectedPage.value,
                              onPressed: () {
                                hmSalesOrderController.lstrSelectedPage.value = "IT";
                                changePage(0);
                              },
                        ...
                        Flexible(
                          child: TabButton(
                              ...
                              hmSalesOrderController.selectedPage.value,
                              onPressed: () {
                                hmSalesOrderController.lstrSelectedPage.value = "CD";
                                changePage(1);
                              },
                        ...
                        Flexible(
                          child: TabButton(
                              ...
                              hmSalesOrderController.selectedPage.value,
                              onPressed: () {
                                hmSalesOrderController.lstrSelectedPage.value = "OT";
                                changePage(2);
                              },
                        ...
                        children: [
                          Expanded(
                            child: PageView(
                              ...
                              controller:
                              hmSalesOrderController.pageController,
                              children: [
        ...
        bottomNavigationBar: Obx(
            ...
            type: "booking",
            mode: hmSalesOrderController.wstrPageMode.value,
            fnAdd: hmSalesOrderController.fnAdd,
            fnEdit: hmSalesOrderController.fnEdit,
            fnCancel: hmSalesOrderController.fnCancel,
            fnPage: hmSalesOrderController.fnPage,
            fnSave: hmSalesOrderController.fnSave,
            fnDelete: hmSalesOrderController.fnDelete,
          )
              : (hmSalesOrderController.wstrPageMode.value == "ADD" ||
              hmSalesOrderController.wstrPageMode.value == "EDIT")
              ? Padding(
            ...
            child: Row(
              children: [
                Expanded(
                  child: Bounce(
                    onPressed: () {
                      ...
                      hmSalesOrderController.fnSave(context);
                    },
                    duration: const Duration(milliseconds: 110),
                    child: Container(
                ...
                Bounce(
                  onPressed: () {
                    hmSalesOrderController.fnCancel();
                  },
                  duration: const Duration(milliseconds: 110),
                  child: Container(
        ...
        floatingActionButton: Obx(() => (hmSalesOrderController.wstrPageMode.value != "VIEW" && hmSalesOrderController.g.wstrCylinderContractYN!="Y" )? Padding(
          ...
          child: FloatingActionButton(
            ...
            tooltip: 'Add Items',
            onPressed: () {
              hmSalesOrderController.wOpenBottomSheet(context);
            },
...
//===============================================WIDGETS
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        wRoundTxtField(hmSalesOrderController.txtTotalAmt,disable: "D")
                      ],
                    ),
                  ),
                  gapHC(5),
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        wRoundTxtField(hmSalesOrderController.txtDiscountAmt,fieldName: "disAmt",
                            oncahnged: (value){
                              // salesController.fnCalc();
                              hmSalesOrderController.fnPaymntCalc();
                            })
                      ],
                    ),
                  ),
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        wRoundTxtField(hmSalesOrderController.txtTaxAmt,disable: "D")
                      ],
                    ),
                  ),
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        wRoundTxtField(hmSalesOrderController.txtRoundAmt,keybordType: "txtKeybrd",oncahnged: (val){
                          // salesController.fnCalc();
                          hmSalesOrderController.fnPaymntCalc();
                        })
                      ],
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        wRoundTxtField(hmSalesOrderController.txtNetAmt,disable: "D")
                      ],
                    ),
                  ),
                  gapHC(5),
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        wRoundTxtField(hmSalesOrderController.txtPaidAmt,
                            oncahnged: (val){
                              // salesController.fnCalc();
                              hmSalesOrderController.fnPaymntCalc();
                            })
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        wRoundTxtField(hmSalesOrderController.txtBalanceAmt,disable: "D")
                      ],
                    ),
                  ),
                  gapHC(15),
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            wRoundedInputField(
                hmSalesOrderController.txtCustomerName, "Customer Name", "N",enable: false,
                prefixicon: Icons.drive_file_rename_outline),
            gapHC(10),
            wRoundedInputField(
                hmSalesOrderController.txtContactNo, "Contact No", "N",enable: false,
                prefixicon: Icons.phone_android_outlined),
            gapHC(10),

            wRoundedInputField(
                hmSalesOrderController.txtBuildingCode, "Building Code", "N",enable: false,
                prefixicon: Icons.apartment),
            gapHC(10),
            wRoundedInputField(
                hmSalesOrderController.txtApartmentCode, "Apartment Code", "N",enable: false,
                prefixicon: Icons.apartment),
            gapHC(10),
            wRoundedInputField(
          ...
          Bounce(
            ...
            onPressed: (){
              if(hmSalesOrderController.wstrPageMode.value  == "VIEW"){
                ...
                dprint(" VehicleNumb Lookupp");
                hmSalesOrderController.fnLookup("LOCMAST");
              }
            },
            child: CommonTextField(
              lookupY: true,
              ...
              sufixIconColor: Colors.black,
              prefixIconColor: black,
              txtController: hmSalesOrderController.txtlocation,
              enableY:false,
            ),
          )
        ],
  ...
  wRoundTxtField(controller,{disable,keybordType,fieldName,ValueChanged<String>? oncahnged}){
    return   Container(
      ...
      child: Center(
        child: TextFormField(
            enabled: hmSalesOrderController.wstrPageMode=="VIEW" || disable=="D"?false:true,
...
//===============================================FUNCTIONS
  changePage(int pageNum) {
    hmSalesOrderController.selectedPage.value = pageNum;
    hmSalesOrderController.pageController.animateToPage(
      pageNum,
